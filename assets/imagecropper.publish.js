		...
		return this.each(function() {
			...
			function createCropper() {
				...
				if (o.image_width > box_width) {
					...
					//image_path = Symphony.Context.get('root') + '/image/1/' + o.image_width + '/' + o.image_height +'/'+ o.image_file;
					...
					$image = $('<img style="max-width:100%;" width="' + o.image_width + '" height="auto" src="' + image_path + '"/>'); //' + o.image_height + '
				} else {
					var load_path = $('.imagecropper.frame').attr('data-related_field_id');					
					var id = '#field-' + load_path;
					var value = $(id).find('label').find('.frame').find('input').val();						
